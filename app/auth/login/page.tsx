        ...
        <div className="w-full max-w-md">
          ...
          <div className="rounded-2xl p-8 border" style={{ 
            ...
            <button
              ...
              disabled={loading}
              className="w-full py-3 rounded-xl text-sm font-semibold transition-all hover:opacity-90 disabled:opacity-40 disabled:cursor-not-allowed flex items-center justify-center gap-3 mb-3"
            ...
            <button
              ...
              style={{ background: '#000000', color: '#FFFFFF', cursor: 'pointer' }}
            >
